import pyttsx3, socket, random, time, pyautogui, keyboard, option, ctypes, platform, subprocess, ssl, csv, sys, re
...
client_ssid = "COSMOTE-782884"
path_to_file = r"C:\Users\Dark-Kings\Documents\Projects\password.txt"
...
#ctypes.windll.kernel32.SetConsoleTitleW('DARK - NIGHT (Credit @Zyxl) - (Version 0.5)')
...
time.sleep(5)
print( )
print("[1]==>[Work] -> Ddos [PowerTool @Zyxl]")
print( )

option = input("Select functions => ")
...
print( )
time.sleep(2)
print('Connecting to Dark Night Servers :/')
print( )
for i in tqdm(range(10),desc="Dark - Night - Server"):
    time.sleep(0.2)
print( )
